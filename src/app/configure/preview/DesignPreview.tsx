...
const DesignPreview = ({ configuration }: { configuration: Configuration }) => {
        ...
        onSuccess: ({url}) => {
         ...
         onError:() => {
            toast({
                ...
                description: "There was error on our end. Please try again later.",
                variant:"destructive"
            })
         }
    })
    ...
    return <>
        ...
        <div className="mt-20 flex flex-col items-center md:grid grid-cols-1 text-sm sm:grid-cols-12
        smg:grid-rows-1 sm:gap-x-6 md:gap-x-8 lg:gap-x-12">
            <div className=" md:col-span-4 lg:col-span-3 md:row-span-2 md:row-end-2">
                <Phone className={cn(`bg-${tw}`,"max-w-[150px] md:max-w-full")} imgSrc={configuration.croppedImageUrl!} />
            </div>
            <div className="mt-6 sm:col-span-9 md:row-end-1">
                <h3 className="text-3xl font-bold tracking-tight text-gray-900">You {modelLabel} case</h3>
            ...
            <div className="sm:col-span-12 md:col-span-9 text-base">
                <div className="grid grid-cols-1 gap-yp8 border-b border-gray-200 py-8
