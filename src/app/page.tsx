              ...
              <div>
                ...
                <div className="mt-12 flex flex-col sm:flex-row items-center
                  ...
                  <div className="flex -space-x-4">
                   ...
                   ring-2 ring-slate-100" src="/users/user-1.png" alt="user-1" />
                    <img
                      className="inline-block h-10 w-10 rounded-full
                   ring-2 ring-slate-100" src="/users/user-2.png" alt="user-2" />
                    <img
                      className="inline-block h-10 w-10 rounded-full
                   ring-2 ring-slate-100" src="/users/user-3.png" alt="user-3" />
                    <img
                      className="inline-block h-10 w-10 rounded-full
                   ring-2 ring-slate-100" src="/users/user-4.jpg" alt="user-4" />
                    <img
                      className="inline-block h-10 w-10 rounded-full
                   ring-2 ring-slate-100" src="/users/user-5.jpg" alt="user-5" />
                  </div>
          ...
          <div className="col-span-full lg:col-span-1 w-full flex justify-center px-8
            ...
            <div className="relative md:max-w-xl">
              ...
              <img src="/your-image.png"
                alt="logo"
                className="absolute w-40 left-56 -top-20
                          select-none hidden sm:block lg:hidden xl:block" />
              <img src="/line.png"
                alt="line"
                className="absolute w-20 h-20 -left-6 -bottom-6 select-none" />
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            ...
            grid-cols-2 gap-40">
              ...
              bg-gray-900/5 ring-inset ring-gray-900/10 lg:rounded-2xl">
                <img src="/horse.jpg" alt="horse" className="rounded-mb object-cover
