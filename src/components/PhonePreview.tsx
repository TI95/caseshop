...
const PhonePreview = ({ croppedImageUrl, color }: {
    ...
    const [renderedDimensions, serRenderedDimensions] = useState({
        width: 0,
        height: 0,
    })
    ...
    const handleResize = () => {
       ...
       serRenderedDimensions({ width, height })
    ...
    return (
        (<AspectRatio
            ...
            <div className="relative h-full w-full z-40">
                <img src="/clearphone.png" alt="phone" className="pointer-events-none h-full w-full antialiased" />
            </div>
        </AspectRatio>)
    );
